...
\ntaddfile{chapter}{Introducao}
% \ntaddfile{chapter}{BaseTeorica}
\ntaddfile{chapter}{RevisaoLiteratura}
\ntaddfile{chapter}{Desenvolvimento}
\ntaddfile{chapter}{Resultados}
\ntaddfile{chapter}{Conclusao}
...
\ntaddfile{appendix}{appendix}
% \ntaddfile{appendix}{appendix_images}
