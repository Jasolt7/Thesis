# -*- coding: utf-8 -*-
"""
Created on Wed Oct  8 10:33:56 2025
...
def main(n_runs, n_threads, max_rows, max_cols, seed, Lk, freeze_crit, temp_red, ratio):
    ...
    results = Parallel(n_jobs=n_threads,  backend="threading")(delayed(SA)(max_rows, max_cols, c_in, seed, Lk, freeze_crit, temp_red, ratio) for seed in range(n_runs))
    ...
    print(Lk, freeze_crit, temp_red, ratio)    
...
main(100, 10, 100, 100, 50, int(1 * (100 * 100)), 20, 0.8, 0.5)